...
class PlacePickerActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun getIntentData() {
        latitude =
            intent.getDoubleExtra(Constants.INITIAL_LATITUDE_INTENT, Constants.DEFAULT_LATITUDE)
        longitude =
            intent.getDoubleExtra(Constants.INITIAL_LONGITUDE_INTENT, Constants.DEFAULT_LONGITUDE)
        ...
        defaultLocale = intent.getStringExtra(Constants.LOCALE_INTENT)
    ...
    private fun setAddress(
        ...
        val geoCoder = Geocoder(this, Locale(defaultLocale))
        try {
